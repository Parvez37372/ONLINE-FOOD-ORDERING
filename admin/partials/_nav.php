    ...
    <header class="header" id="header">
        ...
        <div class="header__img">
            <img src="assetsForSideBar/img/athar.jpg" alt="">
        </div>
    </header>
        ...
        <nav class="nav">
            <div>
                <a href="index.php" class="nav__logo">
                    ...
                    <span class="nav__logo-name">Al-Umar-Resturant</span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <a href="http://localhost/onlinefood/" class="nav__link nav-siteManage">
                      <i class="bx bx-grid-alt nav__icon"></i>
                      <span class="nav__name">A-Umar-Resturant</span>
                    </a>
                </div>
            </div>
